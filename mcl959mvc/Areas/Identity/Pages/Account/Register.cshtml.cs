        ...
        { 
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (result.Succeeded)
                    {
                        _logger.LogInformation($"New user created with email address '{Input.Email}'.");
                        ...
                        TempData["PopupMessage"] = $"A confirmation email has been sent to {Input.Email}. Please check your email and confirm your account before logging in.";
